...
# run_episode(wrappers.Monitor(env, '/tmp/frozenlake1', force=True), )
...
if __name__ == '__main__':
    ...
    # note to self: the underscore can be used as a throwaway value, like when
    # you want to do something x times but don't care about the value of x
